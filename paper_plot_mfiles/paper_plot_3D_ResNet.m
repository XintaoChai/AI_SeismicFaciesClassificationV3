...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FigureName = ['FigMergeAllYpred' 'ResNet' num2str(net_case)];
FigureName = ['FigMergeAllYpred' 'ResRaw'];
figure('name',FigureName);clf;
set(gcf,'color','white','windowstyle','normal','Units','inches','Position',iWindowPosition1);
set(gcf, 'PaperPositionMode', 'auto');
slice(xShotNsCoordinate,yRecNrCoordinate,zNzCoordinate,permute(Training_Test1_Test2_Labels_ResNet4(:,:,:),[2 3 1]),xShotNsSlices,yRecNrSlices,zNzSlices,'cubic');
caxis(iCaxisY);
text(MIOUXYZ(1), MIOUXYZ(2), MIOUXYZ(3),['mIoU = ' num2str(eval_scores_ResNet4(:,4,eval_scores_ID),'%.4f')],'rotation',0,'FontName','Arial','FontSize',iFontSize,'FontWeight','normal');
arrows_ShortCuts;
test3DCommonDown_Y;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
FigureName = ['FigMergeAllYpred' 'ResGood'];
figure('name',FigureName);clf;
