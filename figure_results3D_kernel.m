...
eval_scores_ID = 1;
eval_scores_Kernel9 = BinDataRead('3_All_iline_patchR992C576_batch16_number10000_stride45_5_loss5_lr100_pool1_kernelSize9_Net5_kernels16_repeat1_dila1_repro1_norm5522_models3_3_cube_eval_scores_1x5x1.bin',[1 5 1]);
Kernel9_iD = ['3_All_iline_patchR992C576_batch16_number10000_stride45_5_loss5_lr100_pool1_kernelSize9_Net5_kernels16_repeat1_dila1_repro1_norm5522_Y_pred_1006x1116x841_model3'];

% eval_scores_ID = 7;
% eval_scores_Kernel9 = BinDataRead('3_All_iline_2patchR992C576_batch16_number10000_stride8_8_loss5_lr1000_pool1_kernelSize11_Net5_kernels16_repeat1_repro2_models1_10_cube_eval_scores_1x5x10.bin',[1 5 10]);
% Kernel9_iD = ['3_All_iline_2patchR992C576_batch16_number10000_stride8_8_loss5_lr1000_pool1_kernelSize11_Net5_kernels16_repeat1_repro2_Y_pred_1006x1116x841_model7'];



tic
Training_Test1_Test2_Labels_Kernel9 = BinDataRead([Kernel9_iD '.bin'],[ZsPro XlinesPro IlinesPro]);
toc
 
paper_plot_3D_Kernel;
