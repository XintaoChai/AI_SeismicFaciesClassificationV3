...
eval_scores_ID = 1;
eval_scores_Loss2 = BinDataRead('3_All_iline_patchR992C576_batch16_number10000_stride45_5_loss2_lr100_pool1_kernelSize11_Net5_kernels16_repeat1_models3_3_cube_eval_scores_1x5x1.bin',[1 5 1]);
Loss2_iD = ['3_All_iline_patchR992C576_batch16_number10000_stride45_5_loss2_lr100_pool1_kernelSize11_Net5_kernels16_repeat1_Y_pred_1006x1116x841_model3'];
tic
Training_Test1_Test2_Labels_Loss2 = BinDataRead([Loss2_iD '.bin'],[ZsPro XlinesPro IlinesPro]);
toc
